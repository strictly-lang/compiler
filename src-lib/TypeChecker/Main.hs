...
findTypehandler :: TypeHandler a => TypeHandlerContext a -> Maybe ASTTypeDeclaration -> TypeValue -> Maybe a
findTypehandler typeHandlerContext = findTypehandler' typeHandlerContext (runTypes typeHandlerContext)

findTypehandler' :: TypeHandler a => TypeHandlerContext a -> [TypeHandlerContext a -> Maybe ASTTypeDeclaration -> TypeValue -> Maybe a] -> Maybe ASTTypeDeclaration -> TypeValue -> Maybe a
